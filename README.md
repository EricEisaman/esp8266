...
**Note:** You can develop with or build production devices with either board. The obvious benefit of the ESP8266-01 production boards is their lower price, not that either model is cost prohibitive. Flashing the firmware on the ESP8266 development boards can be done simply with a micro-usb cable.
